...
def getTeamPastMatchesFromDB(teamName, country):
    pastMatches = dbHelper.getTeamPastMatch(teamInfo=(teamName, country))
    return pastMatches
...
def getScheduledMatches(day):
    ...
    try: 
        return SCHEDULEDMATCHES[day]
        
    except:
        matches = getScheduledMatchStat(day)
        SCHEDULEDMATCHES[day] = matches
